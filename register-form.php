...
<?php $userAgreementRequired = apply_filters('mbl_user_agreement_enabled_registration', wpm_option_is('user_agreement.enabled_registration', 'on'));  ?>
<form class="wpm-registration-form" name="wpm-user-register-form" action="" method="post">
    ...
    <?php if (wpm_option_is('registration_form.custom1', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom1" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom1_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom2', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom2" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom2_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom3', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom3" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom3_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom4', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom4" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom4_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom5', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom5" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom5_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom6', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom6" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom6_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom7', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom7" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom7_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom8', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom8" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom8_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom9', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom9" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom9_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom10', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <input type="text" name="custom10" value="" class="form-control" placeholder="<?php echo wpm_get_option('registration_form.custom10_label'); ?>" required="">
        </div>
    <?php endif; ?>
    <?php if (wpm_option_is('registration_form.custom1textarea', 'on')) : ?>
        <div class="form-group form-icon form-icon-pencil">
            <textarea name="custom1textarea" class="form-control" rows="5" placeholder="<?php echo wpm_get_option('registration_form.custom1textarea_label'); ?>" style="resize: none;" required=""></textarea>
        </div>
    <?php endif; ?>
    ...
    <?php if (wpm_option_is('main.enable_captcha', 'on') && wpm_option_is('main.enable_captcha_registration', 'on')) : ?>
        <div class="form-fields-group">
            <div class="g-recaptcha" data-sitekey="<?php echo wpm_get_option('main.captcha_key'); ?>" data-is-mobile="<?php echo MBLStats::isMobile() ? 1 : 0; ?>"></div>
        </div>
    <?php endif; ?>

    <div class="result alert alert-warning ajax-result"></div>

    <input type="submit" class="mbr-btn btn-default btn-solid btn-green text-uppercase register-submit <?php echo $userAgreementRequired ? 'mbl-uareq' : ''; ?>" <?php echo $userAgreementRequired ? 'disabled="disabled"' : ''; ?> name="wpm-register-submit" value="<?php _e('Зарегистрироваться', 'mbl'); ?>">
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $(document).on('click', '.wpm_generate_pin_code_button', function() {
                ...
                $('.pin-code-error').hide();
                $.post(ajaxurl, {
                    action: 'wpm_get_pin_code_action'
                }, function(data) {
